      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-3 mb-1">
            ...
            <h1 className="text-2xl font-black gradient-bleu-or-text uppercase tracking-tighter">Espace Communication</h1>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="flex items-center gap-3 overflow-x-auto no-scrollbar pb-2">
            {['Tous', 'Annonce', 'Message', 'Urgent'].map(f => (
              <button
                ...
                className={`
                  px-5 py-2.5 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] transition-all whitespace-nowrap
                  ${activeFilter === f 
                    ...
                    <div className="flex gap-5">
                      ...
                      <div>
                        <div className="flex items-center gap-3 mb-2">
                          <h4 className="font-black text-gray-900 dark:text-white uppercase tracking-tight text-lg">{msg.titre}</h4>
                        ...
                        <div className="flex flex-wrap items-center gap-6">
                          <div className="flex items-center gap-2 text-[9px] font-black uppercase text-gray-400 dark:text-gray-500 tracking-widest">
                            <Users size={14} className="text-bleu-500" /> Cible: {msg.cible}
                          </div>
                          <div className="flex items-center gap-2 text-[9px] font-black uppercase text-gray-400 dark:text-gray-500 tracking-widest">
                            <Clock size={14} className="text-or-500" /> {msg.date}
                          </div>
                          <div className="flex items-center gap-2 text-[9px] font-black uppercase text-vert-500 dark:text-vert-400 tracking-widest">
        ...
        <div className="space-y-6">
          <Card className="p-8 border-none shadow-soft bg-gradient-to-br from-gray-900 to-gray-800 dark:from-gray-950 dark:to-gray-900 text-white relative overflow-hidden">
             ...
             <h3 className="font-black uppercase tracking-[0.2em] text-[10px] text-bleu-400 mb-8 flex items-center gap-3">
               <Users size={16} />
               Canaux de Diffusion
             </h3>
             <div className="space-y-8">
               {[
                 ...
                 <div key={i} className="flex items-center justify-between group cursor-pointer">
                   <div>
                     <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-1 group-hover:text-bleu-400 transition-colors">{c.label}</p>
                     <p className="text-2xl font-black tracking-tight">{c.count}</p>
                   </div>
                   <Badge variant="default" className="bg-white/5 text-gray-300 border-white/10 text-[8px] font-black uppercase px-2">{c.status}</Badge>
                 </div>
               ))}
             </div>
             <Button className="w-full mt-10 bg-white dark:bg-or-500 text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-or-400 border-none font-black uppercase tracking-widest text-[10px] h-12 flex gap-3 shadow-lg">
          ...
          <Card className="p-8 border-none shadow-soft bg-white dark:bg-gray-900/50 dark:backdrop-blur-md">
            <h3 className="font-black text-gray-900 dark:text-white uppercase tracking-tight mb-6">Alerte Prochaine</h3>
            <div className="p-5 bg-or-50 dark:bg-or-900/20 border border-or-100 dark:border-or-500/20 rounded-3xl flex items-start gap-5">
              ...
              <div>
                <p className="text-[10px] font-black uppercase text-or-600 dark:text-or-400 mb-1 tracking-widest">Rappel Automatique</p>
                <p className="text-sm font-bold text-gray-700 dark:text-gray-300 leading-relaxed uppercase">Relance des impayés prévue demain à 09:00.</p>
              </div>
            </div>
          </Card>
        </div>
