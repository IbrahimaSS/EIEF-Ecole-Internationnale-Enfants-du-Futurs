...
import {
  ...
  User, MessageSquare, ArrowRightCircle, MessageCircle, Copy, Check, ChevronRight,
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-white font-sans selection:bg-vert-500/30 overflow-x-hidden transition-colors duration-500">
      ...
      <PageHero
        ...
        title={<>Parlons du futur <span className="bg-clip-text text-transparent bg-gradient-to-r from-vert-300 via-vert-400 to-vert-500">de vos enfants</span>.</>}
      ...
      {/* 4 cartes coordonnées cliquables */}
      <section className="py-16 md:py-20 bg-white dark:bg-gray-950 relative z-10">
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-vert-600/10 text-vert-700 dark:text-vert-400 border border-vert-600/20 font-black text-[9px] uppercase tracking-[0.3em] px-4 h-8 rounded-full">Coordonnées</Badge>
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 dark:text-white tracking-tight mb-3">
              Quatre façons de nous <span className="bg-clip-text text-transparent bg-gradient-to-r from-vert-600 to-or-500">joindre</span>
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {contactInfos.map((c, i) => (
              <motion.div
                ...
                onClick={c.action}
                className={cn('group relative p-6 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900/60 dark:to-gray-900/30 rounded-2xl border border-gray-100 dark:border-white/5 hover:shadow-2xl transition-all cursor-pointer overflow-hidden', c.borderHover)}
              >
                ...
                <div className="relative">
                  <div className="flex items-start justify-between mb-5">
                    ...
                    <button
                      onClick={(e) => { e.stopPropagation(); copyToClipboard(c.value, c.key); }}
      ...
      <section className="py-16 md:py-20 bg-[#fafafa] dark:bg-gray-900/50 relative z-10">
        <div className="max-w-[1400px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
              ...
              {horaires.map((h, i) => (
                <li key={i} className="flex items-center justify-between gap-3 pb-3 border-b border-gray-100 dark:border-white/5 last:border-0">
                  <div className="flex items-center gap-3 min-w-0">
                    <span className={cn('w-2 h-2 rounded-full shrink-0', h.open ? 'bg-vert-500 animate-pulse-soft' : 'bg-rouge-400')} />
                    <div className="min-w-0">
                      <p className="text-sm font-black text-gray-900 dark:text-white">{h.jour}</p>
                      {h.note && <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mt-0.5">{h.note}</p>}
                    </div>
                  </div>
                  <span className={cn('text-xs font-black px-3 py-1 rounded-full whitespace-nowrap', h.open ? 'bg-vert-500/10 text-vert-700 dark:text-vert-300' : 'bg-rouge-500/10 text-rouge-600 dark:text-rouge-300')}>
                    {h.heures}
                  </span>
                </li>
              ))}
          ...
          >
            ...
            >
              <Globe size={14} /> Itinéraire <ArrowRightCircle size={14} />
            </a>
          </motion.div>
        </div>
      </section>
      ...
      <section id="formulaire" className="py-20 md:py-24 bg-white dark:bg-gray-950 relative z-10">
        <div className="max-w-[1400px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5 space-y-8 text-left lg:sticky lg:top-24">
            <div>
              <Badge className="mb-4 bg-or-600/10 text-or-700 dark:text-or-400 border border-or-600/20 font-black text-[9px] uppercase tracking-[0.3em] px-4 h-8 rounded-full">Message direct</Badge>
              <h2 className="text-3xl md:text-4xl font-black text-gray-900 dark:text-white tracking-tight mb-3">
                Une question ?{' '}
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-vert-600 to-bleu-700 dark:from-vert-400 dark:to-bleu-400">Écrivez-nous</span>
              </h2>
            ...
            <div className="relative h-56 rounded-3xl overflow-hidden shadow-xl border-4 border-white dark:border-white/10 group">
              <img
                src="/Img4.jpeg"
                onError={(e) => { const img = e.currentTarget; if (!img.src.endsWith('/Img1.jpeg')) img.src = '/Img1.jpeg'; }}
                alt="Campus EIEF"
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    title={label}
                    className={cn('w-12 h-12 bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-xl flex items-center justify-center text-gray-400 transition-all shadow-sm hover:shadow-lg hover:scale-105', col)}
                  >
                    <Icon size={20} />
                  </a>
                ))}
          ...
          <form
            onSubmit={(e) => { e.preventDefault(); alert('Message envoyé. (Démo — à brancher au backend.)'); }}
          ...
          >
            <Badge className="mb-4 bg-vert-600/10 text-vert-700 dark:text-vert-400 border border-vert-600/20 font-black text-[9px] uppercase tracking-[0.3em] px-4 h-8 rounded-full">Formulaire</Badge>
            <h3 className="text-2xl md:text-3xl font-black text-gray-900 dark:text-white mb-3 tracking-tight">
              Envoyez-nous un <span className="bg-clip-text text-transparent bg-gradient-to-r from-vert-600 to-bleu-700 dark:from-vert-400 dark:to-bleu-400">message</span>
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-4">Prénom &amp; Nom <span className="text-rouge-500">*</span></label>
                <div className="relative group">
                  ...
                  <input type="text" required className="w-full h-14 bg-white dark:bg-gray-950 border-2 border-gray-100 dark:border-white/5 focus:border-vert-500 dark:focus:border-or-400 rounded-2xl pl-14 pr-6 outline-none font-bold text-sm transition-all" placeholder="Votre nom complet" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-4">Email <span className="text-rouge-500">*</span></label>
                <div className="relative group">
                  ...
                  <input type="email" required className="w-full h-14 bg-white dark:bg-gray-950 border-2 border-gray-100 dark:border-white/5 focus:border-vert-500 dark:focus:border-or-400 rounded-2xl pl-14 pr-6 outline-none font-bold text-sm transition-all" placeholder="votre@email.com" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input type="tel" className="w-full h-14 bg-white dark:bg-gray-950 border-2 border-gray-100 dark:border-white/5 focus:border-vert-500 dark:focus:border-or-400 rounded-2xl pl-14 pr-6 outline-none font-bold text-sm transition-all" placeholder="+224 ..." />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <select className="w-full h-14 bg-white dark:bg-gray-950 border-2 border-gray-100 dark:border-white/5 focus:border-vert-500 dark:focus:border-or-400 rounded-2xl pl-14 pr-6 outline-none font-bold text-sm transition-all appearance-none">
              ...
              <div className="md:col-span-2 space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-4">Message <span className="text-rouge-500">*</span></label>
                <div className="relative group">
                  ...
                  <textarea required className="w-full h-40 bg-white dark:bg-gray-950 border-2 border-gray-100 dark:border-white/5 focus:border-vert-500 dark:focus:border-or-400 rounded-2xl pl-14 pr-6 pt-5 outline-none font-bold text-sm transition-all resize-none" placeholder="Décrivez votre demande en détail..." />
                </div>
              </div>
            </div>
            ...
            <Button type="submit" className="w-full h-14 bg-gradient-to-r from-or-500 to-or-600 text-gray-950 rounded-2xl font-black text-xs uppercase tracking-widest hover:from-or-400 hover:to-or-500 transition-all shadow-gold flex items-center justify-center gap-2">
