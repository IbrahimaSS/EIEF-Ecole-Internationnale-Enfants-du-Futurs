...
const StudentCommunication: React.FC = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    setError(null);
    try {
      const [a, t] = await Promise.all([getAnnouncements('STUDENT'), getForumTopics()]);
      setAnnonces(a);
      setTopics(t);
    } catch (err: any) {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs font-bold uppercase tracking-widest text-vert-700 dark:text-or-400">
              Échange avec tes profs et la direction
            </p>
          </div>
        </div>
        <div className="flex items-center gap-3">
        ...
        {activeTab === 'annonces' && (
          ...
          >
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-black text-gray-900 dark:text-white">Annonces de l'école</h2>
              <button
                onClick={loadData}
