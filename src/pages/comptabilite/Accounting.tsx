            ...
            <div className="max-w-3xl space-y-4">
              ...
              <div className="space-y-3">
                <h1 className="text-3xl font-black tracking-tight sm:text-4xl">
                  Frais de scolarité et encaissements
                </h1>
                <p className="max-w-2xl text-sm leading-6 text-slate-100/85 sm:text-base">
                  Centralisez les familles, les modalités de paiement et les encaissements divers dans une vue plus lisible, plus pilotable et plus rapide à exploiter au quotidien.
                </p>
              </div>
...
export default ComptableAccounting;
